...
@FilterDef(name = "mobileApplicationFilter", parameters = {@ParamDef(name = "tenantId", type = "int")})
@Filter(name = "mobileApplicationFilter", condition = "tenant_id = :tenantId")
public class MobileApplication extends Base {
